...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private DiscoverySettingsObserver mDiscoverySettingsObserver = new DiscoverySettingsObserver(mHandler);
    private class DiscoverySettingsObserver extends ContentObserver {
        DiscoverySettingsObserver(Handler handler) {
            super(handler);
        }
